...
function InsuranceDetails(props) {
  ...
  const [activeItem2Plus, setActiveItem2Plus] = useState("2 plus Minimal (ซ่อมอู่)")
  ...
  useEffect(() => {
    if (props.insuranceType == "ประเภท 1") setSelectedType(props.insuranceType)
    if (props.insuranceType != "ประเภท 1") setSelectedType(props.insuranceType)
  })

  var list
  if (selectedType == "ประเภท 1") list = <TypeOneTable />
  if (selectedType == "ประเภท 2") {
    list =
      <Grid>
        <Grid.Column width={3}>
  ...
  if (selectedType == 'ประเภท 2 plus') {
    list =
      <Grid>
        <Grid.Column width={3}>
          <Menu fluid vertical tabular>
            <Menu.Item
              name='2 plus Minimal (ซ่อมอู่)'
              active={activeItem2Plus === '2 plus Minimal (ซ่อมอู่)'}
              onClick={handleItemClick2Plus}
            />
            <Menu.Item
              name='2 plus 35 UP'
              active={activeItem2Plus === '2 plus 35 UP'}
              onClick={handleItemClick2Plus}
            />
            <Menu.Item
              name='2 plus MAX (ซ่อมอู่)'
              active={activeItem2Plus === '2 plus MAX (ซ่อมอู่)'}
              onClick={handleItemClick2Plus}
            />
            <Menu.Item
              name='2 plus MAX (ซ่อมห้าง)'
              active={activeItem2Plus === '2 plus MAX (ซ่อมห้าง)'}
              onClick={handleItemClick2Plus}
            />
          </Menu>
        </Grid.Column>
  ...
  if (selectedType == "ประเภท 3 plus") list = <TypeThreePlueTable />
